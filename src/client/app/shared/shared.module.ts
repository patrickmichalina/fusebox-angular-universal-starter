...
import { MdButtonModule, MdTabsModule, MdToolbarModule } from '@angular/material'
...
@NgModule({
  imports: [CommonModule, RouterModule, Angulartics2Module.forChild(), MdTabsModule, MdToolbarModule, MdButtonModule],
