...
export class TransferHttp {
  ...
  post(url: string, body: any, options: RequestOptionsArgs = {}): Observable<any> {
    return this.getPostData(url, body, options, (url: string) => {
  ...
  patch(url: string, body: any, options: RequestOptionsArgs = {}): Observable<any> {
    return this.getPostData(url, body, options, (url: string) => this.http.patch(url, body.options));
  }
  ...
  head(url: string, options: RequestOptionsArgs = {}): Observable<any> {
    return this.getData(url, options, (url: string, options: RequestOptionsArgs) => this.http.head(url, options));
  }
  ...
  options(url: string, options: RequestOptionsArgs = {}): Observable<any> {
    return this.getData(url, options, (url: string, options: RequestOptionsArgs) => this.http.options(url, options));
  }
