...
@NgModule({
  ...
  declarations: [DashboardComponent, DashboardPageFooterComponent, DashboardPageHeaderComponent],
  exports: [DashboardComponent, DashboardPageFooterComponent, DashboardPageHeaderComponent]
})
