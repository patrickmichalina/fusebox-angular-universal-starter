...
- [ ] Provide an ejectable (can be moved to another server) OpenID Identity Server for managing user authentication
- [ ] Provide an ejectable (can be moved to another server) API with some common endpoints
